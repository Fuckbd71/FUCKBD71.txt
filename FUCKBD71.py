...
\033[1;32m==================================================
          ...
          Github     : FUCKBD71
          Version    : \033[1;96mRANDOM CLONE \033[1;31m[m•3]\x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         🍂  HASAN-KING IS A BRAND 🥰          \x1b[0m
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def main():
    ...
    with ThreadPool(max_workers=100) as HASAN:
        ...
        print(f"\033[1;31m[\033[1;96m•\033[1;31m] \033[1;31mFILE SAVE IN /sdcard/HASAN-OK🥰.txt")
        print('\033[1;32m='*50)
        for guru in user:
